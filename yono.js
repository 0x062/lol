...
const AMOUNT_UXION = process.env.AMOUNT_UXION || '1000';  // micro-units of XION
...
async function main() {
  ...
  if (!coin) {
    console.error('Denom uxion not found on Xion chain. Please verify chain denom from above balances.');
    process.exit(1);
  }
